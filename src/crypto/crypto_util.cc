...
std::array<unsigned char, 32> CryptoUtil::Sha256(const std::vector<unsigned char> &data) {
...
std::vector<unsigned char> CryptoUtil::Base64Encode(const std::vector<unsigned char> &data) {
